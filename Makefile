...
debug:
	go build -ldflags="-X github.com/KittyKatt/kuber/system.Version=$(GIT_HEAD)"
...
rmdebug:
	go build -gcflags "all=-N -l" -ldflags="-X github.com/KittyKatt/kuber/system.Version=$(GIT_HEAD)" -race
